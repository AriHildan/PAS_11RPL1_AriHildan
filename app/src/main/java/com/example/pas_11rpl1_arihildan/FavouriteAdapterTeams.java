...
public class FavouriteAdapterTeams  extends RecyclerView.Adapter<FavouriteAdapterTeams.MyViewHolder> {
    ...
    @NonNull
    @Override
    public FavouriteAdapterTeams.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
